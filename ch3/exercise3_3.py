# Write a funtion that draws a grid like the following: 
# to print more than one value on a line, you can print a comma-seperated sequence of values: print('+', '-')
# by default, print advances to the next line, but you can override that behavior and 
# just put a space at the end like this 
# a print statement with no argment ends the current line and goes on to the next line
...
print("This is the four by four grid")
